...
- При нажатии `triggerButton` и если мишень видима (`targetVisible`), активируется триггер `fireTrigger`.
...
- Если `bulletX > 800`, выстрел считается оконченным, координаты сбрасываются.
